tux_course_dim 100 400
tux_course_name "Nebula"
tux_course_author "Ingo Ruhnke <grumbel@gmx.de>"
tux_start_pt 50 2.0  ;# start
...
tux_fog -on -mode linear -start 10 -end 100 -colour { 1.0 1.0 1.0 1.0 }
